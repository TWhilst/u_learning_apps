...
class AppColors {
  ...
  // using static means that the value will never change, eg we are giving primary background a permanent color so using static that we don't want the value to change
  // static is called a modifier
  /// white background
